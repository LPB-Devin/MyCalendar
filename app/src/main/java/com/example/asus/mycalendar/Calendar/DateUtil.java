package com.example.asus.mycalendar.Calendar;
...
public class DateUtil {
    ...
    public static int getWeekDayFromDate(int year, int month) {
        ...
        int week_index = cal.get(Calendar.DAY_OF_WEEK) - 2;//鍛ㄤ竴绗竴澶�
        if (week_index < 0) {
            week_index = 6;
        }
//        int week_index = cal.get(Calendar.DAY_OF_WEEK) - 1;//鍛ㄦ棩绗竴澶�
//        if (week_index < 0) {
//            week_index = 0;
//        }
        return week_index;
